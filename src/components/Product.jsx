    ...
    <>
      ...
      <div className="col-md-6 col-lg-4 my-4 row align-items-center">
        ...
        <div className="col-8">
          ...
          {/* <button type="button" className="btn btn-dark w-100" onClick={() => handleClick(detailGuit)}> */}
          {/* <button type="button" className="btn btn-dark w-100" onClick={() =>  setCart( prevCart => ([...prevCart, detailGuit]))}> */}
